    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('alternative_title', models.JSONField(blank=True, default=None, null=True, verbose_name='Альтернативные названия')),
                ('slug', models.SlugField(unique=True, verbose_name='Слаг')),
                ('description', models.TextField(verbose_name='Описание')),
                ...
                ('episodes_realesed', models.PositiveSmallIntegerField(verbose_name='Эпизодов вышло')),
                ('season', models.DateField(verbose_name='Сезон выхода')),
